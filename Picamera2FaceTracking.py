...
picam2.preview_configuration.align() ## aligns the size to the closest standard
#format
...
#tstart=time.time()
    ...
    for face in faces:
        ...
        os.system("mpg321 TTSaudio.mp3")
        sense.show_message("ALERT FACE", text_colour=blue, scroll_speed=0.01)
        
        
#at intersection of each point there is an array of three numbers for RGB i.e.
#[R,G,B] where RGB value ranges from 0 to 255
...
## the above command will only grab the frame
    ...
    #print("frames per second are",int(fps)) ## if you increase the resolution of
#the image the fps will go down
